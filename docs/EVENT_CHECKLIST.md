...
The published submission window is **15 July 2026, 9:30 AM IST to 31 October 2026, 5:00 PM IST**. The deadline is **11:30 AM UTC on 31 October**. Judging is scheduled for 1–9 November, with winners on 10 November. Recheck immediately before submission. [Official schedule](https://galuxium-nexus-v2-29411.devpost.com/details/dates)

## Account and participation checks
...
The [Q4 extension notice](https://galuxium-nexus-v2-29411.devpost.com/updates/45996-official-board-notice-expansion-to-q4-global-summit-timeline-extension) explicitly makes Discord membership mandatory for individuals and teams. Its [official invitation](https://discord.com/invite/J3Tbd3vXdr) is the appropriate starting point. The [later resource update](https://galuxium-nexus-v2-29411.devpost.com/updates/46347-action-required-join-official-discord-server-for-100-ai-credits-live-support) directs builders to `#announcements` and `#resource-portal`; it describes a whitelist form for $100 Adaption credits. Eligibility for, expiry of, and successful allocation of those credits have not been verified for this account.
...
1. Confirm registered-participant status, then sign in or create the required Backboard account.
2. Open the [Backboard billing dashboard](https://app.backboard.io/dashboard/billing).
...
Two organizer-controlled pages currently disagree:

| Published source | Observed description |
| --- | --- |
| [Devpost event page](https://galuxium-nexus-v2-29411.devpost.com/) | $14,944 total advertised value. Each of the three prize descriptions explains that its stated cash value is infrastructure/software value, with no direct cash payout under that tier. |
| [Galuxium website](https://www.galuxium.com/) | $2,600 total: $1,000/$500/$100 Backboard credit tiers plus a discretionary seed pool of up to $1,000. It also lists a verified $5/month Backboard Starter requirement for the first credit tier and account verification for the other credit tiers. |

These descriptions cannot establish a single reliable payout expectation. The website's paid-account wording appears beside prize tiers; that is not sufficient evidence of a general entry fee. Keep any prize out of Pactshift's financial projections. If prize terms matter to the decision to participate or activate a paid plan, seek a written clarification through the official organizer channel. No clarification or payment has occurred here.
