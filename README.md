...
| AI | Canonical hosted smoke executed `vertex` / `gemini-2.5-flash-lite` with three validated citations. Actual Vertex analysis was also verified in the mobile browser journey. |
...
| Additional UI checks | At 768×1024, dashboard and project modal fit the viewport without overflow. Authenticated mobile export triggered a download with no console errors or warnings observed. Disposable QA fixtures were deleted successfully. |
